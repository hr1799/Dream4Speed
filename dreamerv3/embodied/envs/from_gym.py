...
class FromGym(embodied.Env):
  ...
  def obs_space(self):
    # Checks if the observation_space has a spaces attribute
    # If yes, spaces is the dict of observation spaces, else use the key provided
    print("self._obs_dict: ", self._obs_dict)
  ...
  def act_space(self):
    print("ACTION")
    print("self._act_dict: ", self._act_dict)
